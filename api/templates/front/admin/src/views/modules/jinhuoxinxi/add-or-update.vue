<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="进货编号" prop="jinhuobianhao">
					<el-input v-model="ruleForm.jinhuobianhao" placeholder="进货编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jinhuobianhao" label="进货编号" prop="jinhuobianhao">
					<el-input v-model="ruleForm.jinhuobianhao" placeholder="进货编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="进货数量" prop="jinhuoshuliang">
					<el-input v-model="ruleForm.jinhuoshuliang" placeholder="进货数量" clearable  :readonly="ro.jinhuoshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="进货数量" prop="jinhuoshuliang">
					<el-input v-model="ruleForm.jinhuoshuliang" placeholder="进货数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="进货时间" prop="jinhuoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jinhuoshijian" label="进货时间" prop="jinhuoshijian">
					<el-input v-model="ruleForm.jinhuoshijian" placeholder="进货时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	computed: {
		...
		zongjiage:{
			get: function () {
				return 1*this.ruleForm.jinhuoshuliang*this.ruleForm.jiage
			}
		},

	},
	created() {
		this.ruleForm.jinhuoshijian = this.getCurDate()
	},
	methods: {
