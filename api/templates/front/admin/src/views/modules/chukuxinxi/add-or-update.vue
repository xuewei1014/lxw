<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="出库编号" prop="chukubianhao">
					<el-input v-model="ruleForm.chukubianhao" placeholder="出库编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chukubianhao" label="出库编号" prop="chukubianhao">
					<el-input v-model="ruleForm.chukubianhao" placeholder="出库编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出库时间" prop="chukushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chukushijian" label="出库时间" prop="chukushijian">
