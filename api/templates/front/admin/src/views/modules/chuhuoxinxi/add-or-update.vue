<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="出货编号" prop="chuhuobianhao">
					<el-input v-model="ruleForm.chuhuobianhao" placeholder="出货编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chuhuobianhao" label="出货编号" prop="chuhuobianhao">
					<el-input v-model="ruleForm.chuhuobianhao" placeholder="出货编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="产品分类" prop="chanpinfenlei">
					<el-input v-model="ruleForm.chanpinfenlei" placeholder="产品分类" clearable  :readonly="ro.chanpinfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="产品分类" prop="chanpinfenlei">
					<el-input v-model="ruleForm.chanpinfenlei" placeholder="产品分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="出货数量" prop="chuhuoshuliang">
					<el-input v-model="ruleForm.chuhuoshuliang" placeholder="出货数量" clearable  :readonly="ro.chuhuoshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="出货数量" prop="chuhuoshuliang">
					<el-input v-model="ruleForm.chuhuoshuliang" placeholder="出货数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出货时间" prop="chuhuoshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.chuhuoshijian" 
						type="date"
						:readonly="ro.chuhuoshijian"
						placeholder="出货时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chuhuoshijian" label="出货时间" prop="chuhuoshijian">
					<el-input v-model="ruleForm.chuhuoshijian" placeholder="出货时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	computed: {
		...
		zongjiage:{
			get: function () {
				return 1*this.ruleForm.chuhuoshuliang*this.ruleForm.jiage
			}
		},

	},
	created() {
		this.ruleForm.chuhuoshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='chuhuobianhao'){
							this.ruleForm.chuhuobianhao = obj[o];
							this.ro.chuhuobianhao = true;
							continue;
						}
						...
						if(o=='chuhuoshuliang'){
							this.ruleForm.chuhuoshuliang = obj[o];
							this.ro.chuhuoshuliang = true;
							continue;
						}
						if(o=='jiage'){
						...
						if(o=='chuhuoshijian'){
							this.ruleForm.chuhuoshijian = obj[o];
							this.ro.chuhuoshijian = true;
							continue;
						}
				}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chuhuoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chuhuoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
