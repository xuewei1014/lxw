	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="产品分类" prop="chanpinfenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="存放位置" prop="cunfangweizhi">
					<el-input v-model="ruleForm.cunfangweizhi" placeholder="存放位置" clearable  :readonly="ro.cunfangweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="存放位置" prop="cunfangweizhi">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.chanpinxiangqing = this.ruleForm.chanpinxiangqing.replace(reg,'../../../python1icx6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
