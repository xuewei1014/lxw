<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="事件分类" prop="shijianfenlei">
					<el-input v-model="ruleForm.shijianfenlei" placeholder="事件分类" clearable  :readonly="ro.shijianfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="事件分类" prop="shijianfenlei">
					<el-input v-model="ruleForm.shijianfenlei" placeholder="事件分类" readonly></el-input>
				</el-form-item>
			</template>
