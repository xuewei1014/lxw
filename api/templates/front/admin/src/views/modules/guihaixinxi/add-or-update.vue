	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="产品状态" prop="chanpinzhuangtai">
					<el-input v-model="ruleForm.chanpinzhuangtai" placeholder="产品状态" clearable  :readonly="ro.chanpinzhuangtai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="产品状态" prop="chanpinzhuangtai">
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.chanpinzhuangtai='已归还'
