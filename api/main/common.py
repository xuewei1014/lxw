...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python1icx6/examusers/login" ,
            "/python1icx6/examusers/register",
            '/python1icx6/defaultuser/login',
            '/python1icx6/users/login',
        ...
        post_list = [
            '/python1icx6/defaultuser/register',
            '/python1icx6/defaultuser/login',
            '/python1icx6/users/register',
            '/python1icx6/users/login',
            "/python1icx6/examusers/login" ,
            "/python1icx6/examusers/register"
        ]  # 免认证list
