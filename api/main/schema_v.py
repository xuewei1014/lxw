...
@main_bp.route("/python1icx6/cal/<tableName>/<columnName>", methods=['GET'])
def python1icx6_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python1icx6/file/download", methods=['GET'])
def python1icx6_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python1icx6/file/upload", methods=['POST'])
def python1icx6_file_upload():
    '''
    '''
...
@main_bp.route("/python1icx6/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python1icx6_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python1icx6/follow/<tableName>/<columnName>", methods=['GET'])
def python1icx6_follow(tableName, columnName):
    '''
...
@main_bp.route("/python1icx6/location", methods=['GET'])
def python1icx6_location():
    '''
...
@main_bp.route("/python1icx6/matchFace", methods=['GET'])
def python1icx6_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python1icx6/option/<tableName>/<columnName>", methods=['GET'])
def python1icx6_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python1icx6/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python1icx6_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python1icx6/sh/<tableName>", methods=['POST'])
def python1icx6_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python1icx6_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python1icx6/upload/<fileName>", methods=['GET'])
def python1icx6_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python1icx6/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python1icx6/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
